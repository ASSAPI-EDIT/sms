...
banner='''
                        \33[93m   เครดิต : ทีม ASSAPI-EDIT   
                        \33[93m   ผู้ทำ : ทรงเเบด เเต่ เเซดบอย ฯ.
                        \33[93m   ทีงาน : พี'อีอี เอ็ม'ม ฯ.
                        \33[93m   ทีมงาน : Masuro Ryouta 
                        \33[93m   ช่องยูทูป : AssAPI-EDIT
                        \33[93m   หัวหน้าASSAPI-EDIT : ทรงเเบด เเต่ เเซดบอย
'''
